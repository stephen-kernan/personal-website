    ...
    <div className="page-container">
      <Container maxWidth="xl">
        <Paper className="dark-mode-paper" elevation={2}>
          ...
          <Typography variant="h2" sx={{ color: 'primary.main' }} component="h2">The Basics</Typography>

          <section className="sub-section">
                          <Typography variant="h3" component="h3">What Equipment Do I Need?</Typography>
          ...
          <section class="sub-section">
                          <Typography variant="h3" component="h3">What Do I Learn First?</Typography>
          ...
          <section class="sub-section">
                          <Typography variant="h3" component="h3">How Do I Choose?</Typography>
            <Typography variant="body1" component="p">
              Here are a few questions that should help guide you to a good fit.
            </Typography>
            <ol>
              <Typography variant="body1" component="li">🎢 What is fun for you?</Typography>
              <span>
              ...
              <Typography variant="body1" component="li">✅ What are your goals?</Typography>
              <span>
              ...
              <Typography variant="body1" component="li">🙈 Still can’t decide?</Typography>
              <Typography variant="body1" component="p">
          ...
          <section class="sub-section">
                          <Typography variant="h3" component="h3">What Languages Match My Interests?</Typography>
            <Typography variant="body1" component="p">Here's a list of popular languages/libararies by category:</Typography>
            <ol>
              <Typography variant="body1" component="li">
                👉 Front-end
                <ol type="a">
                  <Typography variant="body1" component="li">HTML</Typography>
                  <Typography variant="body1" component="li">CSS</Typography>
                  <Typography variant="body1" component="li">Javascript</Typography>
                  <Typography variant="body1" component="li">React</Typography>
                  <Typography variant="body1" component="li">Bootstrap</Typography>
                  <Typography variant="body1" component="li">Django (if learning Python)</Typography>
                </ol>
              </Typography>
              <Typography variant="body1" component="li">
                👈 Back-end
                <ol type="a">
                  <Typography variant="body1" component="li">Python</Typography>
                  <Typography variant="body1" component="li">Java</Typography>
                  <Typography variant="body1" component="li">C++</Typography>
                  <Typography variant="body1" component="li">Javascript (kind of)</Typography>
                  <Typography variant="body1" component="li">SQL</Typography>
                  <Typography variant="body1" component="li">PostgreSQL</Typography>
                  <Typography variant="body1" component="li">MongoDB</Typography>
                </ol>
              </Typography>
              <Typography variant="body1" component="li">
                📱 Mobile Development{" "}
                <ol type="a">
                  <Typography variant="body1" component="li">Swift (iOS)</Typography>
                  <Typography variant="body1" component="li">Kotlin (Android)</Typography>
                  <Typography variant="body1" component="li">React Native (Both)</Typography>
                </ol>
              </Typography>
              <Typography variant="body1" component="li">
                📈 Data Science
                <ol type="a">
                  <Typography variant="body1" component="li">Python</Typography>
                  <Typography variant="body1" component="li">R</Typography>
                  <Typography variant="body1" component="li">SQL</Typography>
                  <Typography variant="body1" component="li">Scala</Typography>
                </ol>
              </Typography>
            </ol>
          </section>

          <Typography variant="h2" sx={{ color: 'primary.main' }} component="h2">Getting Started</Typography>

          <section class="sub-section">
                          <Typography variant="h3" component="h3">Basic Strategy</Typography>
            ...
            <ol>
              ...
              <Typography variant="body1" component="li">Repeat.</Typography>
            </ol>
          </section>

                        <Typography variant="h3" component="h3">Tips & Tricks</Typography>
          <section class="sub-section">
            <Typography variant="h4" component="h4">Consistency is Key 🔑</Typography>
          ...
          <section class="sub-section">
            <Typography variant="h4" component="h4">Tutorials vs. Exploration 🧪</Typography>
          ...
          <section class="sub-section">
            <Typography variant="h4" component="h4">Pick a Paradigm 🖼</Typography>
          ...
          <Typography variant="h2" sx={{ color: 'primary.main' }} component="h2">Resources</Typography>

          <section class="sub-section">
                          <Typography variant="h3" component="h3">Courses & Tutorials 🙋</Typography>
          ...
          <section class="sub-section">
                          <Typography variant="h3" component="h3">Projects & Practice Problems 👷‍♂️</Typography>
          ...
          <section class="sub-section">
                          <Typography variant="h3" component="h3">Documentation 📖</Typography>
            <Typography variant="body1" component="p">
          ...
          <Typography variant="h2" sx={{ color: 'primary.main' }} component="h2">Appendix</Typography>

                        <Typography variant="h3" component="h3">Debugging: Printing vs. Debugging Tools</Typography>

          <section class="sub-section">
            <Typography variant="h4" component="h4">Printing 🖨</Typography>
          ...
          <section class="sub-section">
            <Typography variant="h4" component="h4">Debugging 🐛</Typography>
            ...
            <Typography variant="body1" component="p">
              ...
              tools in almost any code editor that you choose.
                        ...
                        <Typography variant="h3" component="h3">Terminal vs. IDE</Typography>

          <section class="sub-section">
            <Typography variant="h4" component="h4">Terminal</Typography>
          ...
          <section class="sub-section">
                          <Typography variant="h3" component="h3">IDE/Code Editor</Typography>
